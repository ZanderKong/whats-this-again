(function exposeInlineAIConstants(global) {
  ...
  const TRANSLATIONS = {
    zh: {
      ...
      "content.annotationBasketLabelOne": " 条暂存批注",
      "content.annotationBasketLabelMany": " 条暂存批注",
    ...
    en: {
      ...
      "content.annotationBasketLabelOne": " pending annotation",
      "content.annotationBasketLabelMany": " pending annotations",
