(function exposeInlineAIConstants(global) {
  ...
  const TRANSLATIONS = {
    zh: {
      ...
      "options.privacyNotice": "隐私提示：点击解释会把选中文本、问题和现有页面上下文发送到你配置的模型服务。API Key、历史解释和批注保存在浏览器本地；请不要选择敏感内容，并遵守该服务的隐私政策。",
      "options.question": "提问",
      "options.language": "语言",
      ...
      "onboarding.modelBody": "选择服务商并填写连接信息。API Key 保存在浏览器本地；点击解释时，选中文本、问题和现有页面上下文会发送到你配置的模型服务。请勿选择敏感内容，并遵守该服务的隐私政策。",
      ...
      "content.collapseThreadAbout": "收起关于“{term}”的回答",
      "content.explain": "解释",
    ...
    en: {
      ...
      "options.privacyNotice": "Privacy notice: generating an explanation sends selected text, your question, and existing page context to the model service you configure. API Keys, saved explanations, and annotations stay in local browser storage; do not select sensitive content and follow that service's privacy policy.",
      ...
      "onboarding.modelBody": "Choose a provider and enter the connection details. API Keys stay in local browser storage; generating an explanation sends selected text, your question, and existing page context to the model service you configure. Do not select sensitive content and follow that service's privacy policy.",
      ...
      "content.collapseThreadAbout": "Collapse answers about \"{term}\"",
